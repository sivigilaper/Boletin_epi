---
title: "COVE"
subtitle: "Secretaria de Salud Pública y Seguridad Social de Pereira"
author: "Jorge M. Estrada Alvarez"
...
```{r, echo=FALSE}
casos2022 %>% tabyl(nom_eve) %>% adorn_pct_formatting() %>% arrange(desc(n)) %>% filter(n>20) %>%  flextable::flextable()
```

## Evento de interes en salud pública 
:::::: {.columns}
:::{.column}
...
## Evento de interes en salud pública 2
:::::: {.columns}
:::{.column}
...
## Evento de interes en salud pública 3
:::::: {.columns}
:::{.column}
...
legend(5,65, c("2020","2021"),col=c("black","red"), lty = c(1,1), lwd = c(2,2), bty="n", cex=1)
text(15, 70, "Variación relativa")
...
legend(25,2750, c("IC Inf 95%","IC Sup 95%", "Umbral estacional", "casos 2021"), col=c("green","red","yellow","black"), lty = c(1,1), lwd = c(2,2), bty="n", cex=1)
```

## Canal endemico IRA (Hospitalización SALA - UCI)
:::::: {.columns}
:::{.column}
...
legend(35,20, c("IC Inf 95%","IC Sup 95%", "Umbral estacional", "2021"), col=c("green","red","yellow","black"), lty = c(1,1), lwd = c(2,2), bty="n", cex=1)
```
...
legend(25,2800, c("IC Inf 95%","IC Sup 95%", "Umbral estacional", "2021"), col=c("green","red","yellow","black"), lty = c(1,1), lwd = c(2,2), bty="n", cex=1)
```
...
legend(25,1400, c("IC inf 95%","Media", "IC sup 95%", "2021"), col=c("green","yellow","red","black"), lty = c(1,1), lwd = c(1,1), bty="n", cex=1)
```
