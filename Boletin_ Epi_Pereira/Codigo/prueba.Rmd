...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 44 - 2023} 
...
epi3 <- epi3 %>% 
  filter(as.numeric(semana)<=44) %>%       # SIEMPRE CAMBIAR A LA SEMANA NOTIFICADA DEL BOLETIN
  mutate(semana = as.numeric(semana))
...
según canal endémico (figura 5) se identifica dengue con cambios importantes de aumento en las ultimas dos semanas epidemiologicas, tocando para esta semana 44 el limite superior de incremento.
...
varicela_ajus <- expand.grid(semana = 1:44, sexo_=c("F","M"), gr_edad=c("0-9","10 a 19","20 a 40","Mayores a 40"))
