...
valor <- predict.glm(model, newdata = data.frame(t= c(8)),type = "response") #cambiar a cada semana
...
lines(x = 9, y = valor, col = "blue", type = "p", lwd=4, pch = 18) # ajuste por rezago en la notificaicon por media movil de los ultimas 5 semanas
