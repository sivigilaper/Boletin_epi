...
El microorganismo con mayor incidencia hasta la fecha ha sido el Rhinovirus, con una incidencia acumulada del 19.2% (IC 95%: 15.84% - 23.16%), seguido por el Virus Sincitial Respiratorio (VSR) con 16.3% (IC 95%: 13.18% - 20.05%) y el Enterovirus con 14.1% (IC 95%: 11.16% - 17.64%). Otros virus identificados incluyen Influenza AH1N1 (6.5%), Parainfluenza Virus (4.7%), Influenza A (4.3%), Metaneumovirus (2.9%), Adenovirus (2.5%) e Influenza B (1.3%).

Se observan variaciones en la circulación de algunos virus entre las semanas epidemiológicas 33-35:

Virus cuya circulación disminuyó:
Virus Sincitial Respiratorio (VSR): reducción de 15.4% a 10.3%. Influenza A: descenso de 3.8% a 0%.
Virus cuya circulación aumentó:
Rhinovirus: incremento de 7.7% a 10.3%, Parainfluenza Virus: subió de 0% a 6.9%, Metaneumovirus: pasó de 0% a 6.9%, Enterovirus: incremento de 3.8% a 6.9%.

Estos cambios sugieren un aumento en la circulación de Enterovirus, Parainfluenza Virus y Metaneumovirus, mientras que virus como el VSR y la Influenza A han mostrado una disminución en su incidencia reciente.
...
lines(x = 38, y = valor, col = "blue", type = "p", lwd=4, pch = 18) # ajuste por rezago en la notificaicon por media movil de los ultimas 5 semanas
