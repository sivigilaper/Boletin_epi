...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 19 - 2022} 
...
epi3_1 <- epi3 %>% 
  ...
  filter(as.numeric(semana)<=19)      # SIEMPRE CAMBIAR A LA SEMANA NOTIFICADA DEL BOLETIN
...
En relación a la notificación segun servicio y comparando la semana notificada del actual año con la misma semana del año anterior, se identifica una disminución en la hospitalización IRA en UCI, pero con aumento relativo para hospitalización en sala general de $19.4 \%$ y consulta externa ($44.9 \%$) y disminucion en hospitalización en UCI $-74.3\%$.
