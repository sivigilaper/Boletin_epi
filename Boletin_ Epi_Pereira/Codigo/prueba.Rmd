...
Durante el periodo comprendido entre las semanas epidemiológicas 11 y 14, la dinámica de circulación viral muestra un predominio marcado de los virus pertenecientes a la familia Picornaviridae. El Rhinovirus se posiciona como el principal agente etiológico con una proporción de incidencia global del 43% ($IC95\%: 38 - 48$), aunque se observa una tendencia a la disminución progresiva al comparar el primer intervalo (SE 11-10) donde registró un 53.3%, frente al segundo intervalo (SE 12-13) donde descendió al 47.4%. De manera similar, el Enterovirus mantuvo una presencia importante pero con una reducción moderada, pasando de una incidencia semanal del 36.7% a un 31.6%. En contraste con este descenso de los virus predominantes, se advierte un incremento epidemiológicamente relevante de Influenza A, que experimentó un repunte significativo al elevarse de un 3.3% en la medición inicial a un 13.2% en el cierre del periodo, consolidándose como la tercera causa de aislamiento con un total de 33 casos.
...
Por otro lado, agentes como el Virus Sincitial Respiratorio (VSR) y la Influenza AH1N1 mostraron un comportamiento de cese en su detección hacia las semanas 12-13, cayendo ambos en su incidencia. Esta ausencia de detecciones finales contrasta con el comportamiento de otros virus estables en la vigilancia, como el Adenovirus, que incrementó su actividad del 3.3% al 7.9%, y el Parainfluenza, que tras un silencio inicial alcanzó una incidencia del 7.9% al cierre del reporte. Finalmente, se identifica una circulación marginal y esporádica de Coronavirus, Metaneumovirus  y SARS-CoV-2, este último con dos aislamientos registrados, lo que sugiere una baja presión de este patógeno en el perfil epidemiológico actual frente al resto de virus respiratorios estacionales.
...
valor <- predict.glm(model, newdata = data.frame(t= c(15)),type = "response") #cambiar a cada semana
...
lines(x = 15, y = valor, col = "blue", type = "p", lwd=4, pch = 18) # ajuste por rezago en la notificaicon por media movil de los ultimas 5 semanas
