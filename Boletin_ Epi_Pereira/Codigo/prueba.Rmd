...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 23 - 2022} 
...
En relación a la notificación segun servicio y comparando la semana notificada del actual año con la misma semana del año anterior, se identifica una disminución en la hospitalización IRA en UCI, pero con aumento relativo para hospitalización en sala general de $29.3\%$ y consulta externa ($26.1 \%$) y disminucion en hospitalización en UCI $-79.1\%$.
...
```
Por grupo de edad en la hospitalizaciones por IRA, la mayor concentración de hospitaliaciones a causa infección respiratoria se da en los menores e iguales de 4 años. Ocupando el 40% especificamente en los menores de 1 año.
...
```{r, echo=FALSE, warning=FALSE, fig.height=2.2 , fig.width=7, fig.cap="Positividad muestras tracto respiratorio, Pereira 2022"}
aislamiento %>% 
