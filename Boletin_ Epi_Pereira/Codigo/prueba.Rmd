...
subtitle: "Alertas Tempranas Semana Epidemiologica 14 de 2022"
lang: es
header-includes:
- \usepackage{graphicx}
- \usepackage{fancyhdr}
...
En relación a la notificación segun servicio y comparando la semana notificada del actual año con la misma semana del año anterior, se identifica una disminución en la hospitalización IRA en UCI, pero con aumento relativo para hospitalización en sala general de $22.9 \%$ y disminucion en hospitalización en UCI $-69.7\%$.
...
Para la semana `r ncol(casos_sem)` la hospitalización por IRA en sala general muestra un comportamiento para la ultima semana una disminución en la notificación. (Figura 2).
...
De igual manera en el canal endémico para la notificación por IRA hospitalizados en Unidad de Cuidados Intensivos (UCI) (figura 3), se ubica por debajo del umbral estacional.
