...
subtitle: "Alertas Tempranas Semana Epidemiologica 5 de 2022"
header-includes:
...
epi3_1 <- epi3 %>% 
  ...
  filter(as.numeric(semana)<=5)      # SIEMPRE CAMBIAR A LA SEMANA NOTIFICADA DEL BOLETIN
...
El canal endémico muestra el evento para la semana `r ncol(casos_sem)` se ubica justo por debajo del umbral estacional.
...
En relación a la notificación segun servicio y comparando la semana notificada del actual año con la misma semana del año anterior, se identifica una disminución en la hospitalización IRA en UCI, pero con aumento relativo para hpsitalización en sala general  de $13.1 \%$  y  disminucion en hospitalización en UCI $-78.3\%$ en sala general y urgencias, respetivamente.
...
En consulta externa y urgencias la notificación de infección respiratoria aguda esta por debajo del umbral estacional  para esta semana epidemiologica.
