...
subtitle: "Alertas Tempranas Semana Epidemiologica 15 de 2022"
lang: es
header-includes:
- \usepackage{graphicx}
- \usepackage{fancyhdr}
...
Para la semana `r ncol(casos_sem)` la hospitalización por IRA en sala general muestra un comportamiento para la ultima semana de aumento en la notificación. (Figura 2).
...
De igual manera en el canal endémico para la notificación por IRA hospitalizados en Unidad de Cuidados Intensivos (UCI) (figura 3), se ubica por debajo del umbral estacional pero con incrementos para la ultima semana epidemiologica informada.
...
En consulta externa y urgencias la notificación de infección respiratoria aguda ha estado en forma variable completando dos semanas seguidas por debajo del limite inferior esperado.
