...
canalend <- read_excel("/cloud/project/Boletin_ Epi_Pereira/Datos/canalend2.xlsx")
...
evento_995<-evento_995 %>%
  ...
  mutate(tot_ira= tot_irag+tot_irauci+tot_iraext)  %>% filter(semana<=4) # QUITAR SEMANA 
...
En cuanto a la edad, en las consultas por IRA en servicio de consulta externa y urgencias, la proporción de consultas por IRA en cada grupo de edad se observa una concentración del mas de 10% en los de un año. El canal endemico general para IRA se encuentra en zona de alerta para las primeras cuatro semanas epidemiologicas.
...
El microorganismo con mayor incidencia hasta la fecha ha sido el Rhinovirus, con una incidencia acumulada del 19,2% (IC95%: 16,36 - 22,45), seguido por el Enterovirus con 15,7% y el Virus Sincitial Respiratorio (VSR) con 12,2%.

Se observan variaciones en la circulación de algunos virus entre las semanas epidemiológicas 50-49 y 51-52: mientras que el Rhinovirus aumentó levemente su circulación (23,8% a 26,9%), el Enterovirus disminuyó de 9,5% a 7,7%. Por su parte, otros virus como el VSR no se detectaron en las semanas 51-52 después de una circulación del 4,8% en las semanas 50-49. En cambio, Influenza A disminuyó de 19,0% a 11,5%, y otros virus como Parainfluenza Virus (1,2,3), Influenza B, y Metapneumovirus mostraron variaciones significativas que podrían estar correlacionadas con un aumento en las consultas por infecciones respiratorias agudas (IRA) a los servicios de salud, según lo evidenciado en los canales endémicos.
