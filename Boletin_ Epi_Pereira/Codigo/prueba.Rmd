...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 31 - 2022} 
...
A semana epidemiologica `r ncol(casos_sem)` se han reportado cuatro (n=4)  casos probables de los cuales se tiene confirmación en dos casos (n=2), un caso (n=1) descartado y 1 pendiente de resultado.
