...
ira2018 <- read_csv("/cloud/project/Boletin_ Epi_Pereira/Datos/ira2018.xls") %>% filter(semana<=40)
...
El microorganismo con mayor incidencia hasta la fecha ha sido el Rhinovirus, con una incidencia acumulada del 19.6% (IC 95%: 16.40% - 23.34%), seguido por el Enterovirus con 15.3% (IC 95%: 12.39% - 18.69%) y el Virus Sincitial Respiratorio (VSR) con 15.1% (IC 95%: 12.21% - 18.48%). Otros virus identificados incluyen Influenza AH1N1 (5.8%), Influenza A (4.4%), Parainfluenza Virus (4.2%), Adenovirus (3.0%), Metaneumovirus (3.0%) e Influenza B (1.2%).

Se observan variaciones en la circulación de algunos virus entre las semanas epidemiológicas 38-40:

Virus cuya circulación disminuyó:

Virus Sincitial Respiratorio (VSR): reducción de 4.2% a 0%.
Influenza A: descenso de 12.5% a 0%.
Virus cuya circulación aumentó:

Rhinovirus: incremento de 20.8% a 36.8%.
Enterovirus: aumento de 8.3% a 36.8%.
Adenovirus: incremento de 8.3% a 5.3%.
Estos cambios sugieren un aumento considerable en la circulación de Rhinovirus y Enterovirus, mientras que virus como el VSR y la Influenza A han mostrado una disminución significativa en su incidencia reciente.
...
lines(x = 40, y = valor, col = "blue", type = "p", lwd=4, pch = 18) # ajuste por rezago en la notificaicon por media movil de los ultimas 5 semanas
