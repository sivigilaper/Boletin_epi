...
evento_995<-evento_995 %>%
  ...
  mutate(tot_ira= tot_irag+tot_irauci+tot_iraext)  %>% filter(semana<=46) # QUITAR SEMANA 
...
lines(x = 46, y = valor, col = "blue", type = "p", lwd=4, pch = 18) # ajuste por rezago en la notificaicon por media movil de los ultimas 5 semanas
