...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 29 - 2022} 
...
m1 <- ggplot(varicela %>% 
  ...
  labs(x= "Semana epidemiologica", y = "Casos", title = "0 a 9 años")+
  theme_linedraw()
