...
subtitle: "Alertas Tempranas Semana Epidemiologica 13 de 2022"
lang: es
header-includes:
- \usepackage{graphicx}
- \usepackage{fancyhdr}
...
En relación a la notificación segun servicio y comparando la semana notificada del actual año con la misma semana del año anterior, se identifica una disminución en la hospitalización IRA en UCI, pero con aumento relativo para hospitalización en sala general de $17.7 \%$ y disminucion en hospitalización en UCI $-67.7\%$.
