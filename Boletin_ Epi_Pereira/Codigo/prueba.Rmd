...
- \fancyhead[R]{Secretaria de Salud Pública y Seguridad Social \\ Vigilancia en Salud Pública \\ Semana 9 - 2023} 
...
epi3_1 <- epi3 %>% 
  ...
  filter(as.numeric(semana)<=9)      # SIEMPRE CAMBIAR A LA SEMANA NOTIFICADA DEL BOLETIN
...
varicela_ajus <- expand.grid(semana = 1:9, sexo_=c("F","M"), gr_edad=c("0-9","10 a 19","20 a 40","Mayores a 40"))
